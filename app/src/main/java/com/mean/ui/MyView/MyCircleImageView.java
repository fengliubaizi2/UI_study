...
/**
 * Created by renzhenhua on 2017/10/15.
 */

public class MyCircleImageView extends AppCompatImageView {

    public static final int KEY_SHADOW_COLOR = 0x1E000000;
    public static final int FILL_SHADOW_COLOR = 0x3D000000;
    // PX
    ...
    public class OvalShadow extends OvalShape {
        ...
        public void updateRadialGradient(int diameter) {
